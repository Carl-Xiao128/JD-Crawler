...
public class PriceCheckUtil {  
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(PriceCheckUtil.class);
	
	 private static final String X54 = "s54x54";
    private static final String X450 = "s450x450";
    private static final String X546 = "s546x546";
    private static final String X800 = "s800x800";
    ...
    public static Properties hasProperties(){
		...
		File a =new File("keyword.properties");
		try {   
			prop.load(new InputStreamReader(new FileInputStream(a), "UTF-8"));  
        } catch (IOException e) {   
            e.printStackTrace();   
        }
		return prop;   
	...
	public static void saveByteImage(byte[] b,String dirType,String productName,String imgname) throws Exception{
    	instance.mkDirectory(desktopPath+"\\"+productName+"\\"+dirType);
        FileOutputStream fout = new FileOutputStream(desktopPath+"\\"+productName+"\\"+dirType+"\\"+imgname);
        //将字节写入文件
        fout.write(b);
        fout.close();
    }
