 ...
 * 
 * @项目名称：wupao-job
 * @类名称：MaxDailyRollingFileAppender
 * @类描述：MaxDailyRollingFileAppender extends FileAppender
 * </br>重写RollingFileAppender类
 * </br>实现maxBackupIndex限制日志文件数量功能（定时删除超过N天前的日志文件）
 * @创建人：wyait
 * @创建时间：2017年8月8日 下午2:40:38 
 * @version：1.0.0
 */
public class MaxDailyRollingFileAppender extends FileAppender {
	// 初始化参数
...
class RollingCalendar extends GregorianCalendar {
	...
	int type = MaxDailyRollingFileAppender.TOP_OF_TROUBLE;
	...
	public Date getNextCheckDate(Date now) {
		...
		switch (type) {
		case MaxDailyRollingFileAppender.TOP_OF_MINUTE:
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.MINUTE, 1);
			break;
		case MaxDailyRollingFileAppender.TOP_OF_HOUR:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			this.add(Calendar.HOUR_OF_DAY, 1);
			break;
		case MaxDailyRollingFileAppender.HALF_DAY:
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case MaxDailyRollingFileAppender.TOP_OF_DAY:
			this.set(Calendar.HOUR_OF_DAY, 0);
			this.set(Calendar.MINUTE, 0);
			this.set(Calendar.SECOND, 0);
			this.set(Calendar.MILLISECOND, 0);
			...
			break;
		case MaxDailyRollingFileAppender.TOP_OF_WEEK:
			...
			break;
		case MaxDailyRollingFileAppender.TOP_OF_MONTH:
